...
class Config:
    def __init__(self, main_conf_path='', conf_file='main_config.cfg'):
        self.main_conf_path = main_conf_path 
        self.conf_file = conf_file
        self.main_config = self.read_config(os.path.join(main_conf_path, conf_file))
    ...
    def read_config(self, conf_path):
        ...
        for section in config.sections():
            ...
            section_config["main_conf_path"] = self.main_conf_path
            section_config["conf_file"] = self.conf_file
